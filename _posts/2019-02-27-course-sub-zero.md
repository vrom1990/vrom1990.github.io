...
Курс учит программировать на JavaScript, одном из самых популярных языков программирования — практически весь интернет использует его, все сайты, включая соцсети вроде Facebook и Instagram. И это будет не упрощённая, не урезанная, а наоборот, расширенная версия — за счёт версии библиотеки [Processing](https://ru.wikipedia.org/wiki/Processing) для онлайн-приложений, называемой [P5.js](https://p5js.org/). Как бы ни был далёк человек от программирования, в конце курса он сделает простой, но полноценный проект — видеоигру вроде пинг-понга, простое приложение вроде графического редактора (Paint и подобных), интерактивную инфографику, интерактивное произведение искусства.
...
- Возможность самостоятельно изучить другие популярные языки разработки — Python, Java, Java для Android, 
- Пон
